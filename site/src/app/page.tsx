        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-8">
          ...
          <AnimatedSection delay={0.1}>
            <h2 className="mt-8 font-[var(--font-heading)] text-3xl font-light tracking-tight text-noir md:text-5xl">
              Le bien-etre <em className="italic text-rose-deep">sans frontiere</em>.
            </h2>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <AnimatedSection delay={0.15}>
              ...
              <p className="mt-6 max-w-lg text-base leading-relaxed text-muted">
                Trop longtemps, l'univers du spa a ete percu comme exclusivement
                feminin. Chez GIRL &amp; BOY POWER, nous avons casse les codes :
                ici, hommes et femmes profitent des memes soins d'exception,
                dans un cadre concu pour tous, sans jugement, sans distinction.
              </p>
          ...
          <StaggerContainer className="grid grid-cols-1 gap-12 md:grid-cols-3">
            {[
              ...
              <StaggerItem key={value.title} className="text-center">
                <div className={`mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-cream ${value.color}`}>
